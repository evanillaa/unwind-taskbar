...
function closeGui()
    ...
    ClearPedTasks(PlayerPedId())
    TriggerEvent("unwind-taskbar:disablecontrols", false)
end
...
function taskBar(length,name,runCheck,keepWeapon,vehicle,vehCheck)
    ...
    TriggerEvent("unwind-taskbar:disablecontrols", true)
...
RegisterNetEvent('unwind-taskbar:disablecontrols')
AddEventHandler('unwind-taskbar:disablecontrols', function(status)
    pDisabled = status
